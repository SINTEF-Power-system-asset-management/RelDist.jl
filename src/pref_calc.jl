""" Calculate P_ref."""
function calculate_pref(fname_l::String, fname_reftime::String, fname_temp::String,
        interruption::Interruption, T_aver::Float64)::Interruption
...
function calculate_pref(lp::DataFrame, referencetime::Dict, W_RP::Float64, W_NRP::Float64,
        T_aver::Float64)::Float64
    A, B = get_AB_ext(lp, get_season(referencetime["month"]), get_weekday(referencetime["day"]),
...
function get_AB(lp::DataFrame, season::String, weekday::String, t::DateTime)::Tuple{Float64, Float64}
...
function get_AB_ext(lp::DataFrame, season::String, weekday::String, t::DateTime)::Tuple{Array{Float64,2},Array{Float64,2}}
    h = Dates.hour(t) + 5  # the fifth column of the CSV correspond to time period 00:00 to 00:59
...
function get_season(t::DateTime)
    return ((Dates.monthname(t) != "January" && Dates.monthname(t) != "February" && Dates.monthname(t) != "December") ? "lowseason" : "highseason")
end

function get_season(t::String)
    return ((t != "January" && t != "February" && t != "December") ? "lowseason" : "highseason")
end

function get_weekday(t::DateTime)
    return ((Dates.dayname(t) != "Saturday" && Dates.dayname(t) != "Sunday") ? "hverdag" : "helg")
end
