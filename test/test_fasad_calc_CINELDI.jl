...
ENS = Dict("downstream" => [3, 0.05, 0.0375, 0.025], "upstream" => [0.0625, 0.05, 1.8, 1.2])
...
@test abs(sum(res["reserve_trans_grid-T2"].ENS) - sum([2.10833, 2.48333, 1.265, 1.6267])) <
      epsilon
